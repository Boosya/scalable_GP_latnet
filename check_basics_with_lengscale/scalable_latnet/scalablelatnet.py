...
class ScalableLatnet:
    ...
    def __init__(self, flags, subject, dim, train_data, validation_data, test_data, true_conn, logger):
        ...
        self.mu_g, self.log_sigma2_g, self.mu_o, self.log_sigma2_o, self.o_single_normal, self.log_sigma2_n, self.log_variance = self.initialize_variables()
        ...
        self.ell, self.first_part_ell, self.second_part_ell, self.pred_signals, self.real_signals = self.calculate_ell(
            self.g, self.o, self.log_sigma2_n, self.log_variance, self.train_data)
    ...
    def initialize_variables(self):
        ...
        return mu_g, log_sigma2_g, mu_o, log_sigma2_o, o_single_normal, log_sigma_2_n, log_variance
    ...
    def calculate_ell(self, g, o, log_sigma2_n, log_variance, real_data):
        ...
        return ell, first_part_ell, second_part_ell, tf.reduce_mean(exp_y, axis=0), real_data
