...
class Flags():
    def __init__(self, sims, Ti, s):
        ...
        self.flags = {'sim': sims, 'Ti': Ti, 's': s, 'seed': 1, 'test_percent': 0.1,
                      ...
                      'inv_calculation': 'approx', 'n_approx_terms': 3, 'n_iterations': 1, 'var_steps': 20,
                      'hyp_steps': 20, 'display_step': 10, 'var_learning_rate': 0.01,
                      'hyp_learning_rate': 0.001, 'n_mc': 50, 'n_rff': 10,
