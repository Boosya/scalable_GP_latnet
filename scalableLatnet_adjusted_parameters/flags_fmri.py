...
class Flags():
    def __init__(self, sims, Ti, s):
        ...
        self.flags = {'sim': sims, 'Ti': Ti, 's': s, 'seed': 1, 'test_percent': 0.0,
                      ...
                      'hyp_learning_rate': 0.001, 'n_mc': 10, 'n_rff': 500,
                      'prior_lambda_': 1, 'posterior_lambda_': 0.15, 'init_sigma2_n': 5, 'init_variance': 0.5,
                      'init_lengthscale': 1. / sqrt(Ti), 'init_p': 0.5, 'tensorboard': False, 'kl_g_weight': 0.0000001}
