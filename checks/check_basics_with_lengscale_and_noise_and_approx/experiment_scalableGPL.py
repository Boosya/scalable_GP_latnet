...
# TODO fix A,W, optimize just data
# treat  opt it, use G, fi and see if signals can be predicted well
# just optimize ell and see if we end up in the right signals
# yt = linear x
