...
class ScalableLatnet:
    ...
    def __init__(self, flags, subject, dim, train_data, validation_data, test_data, true_conn, logger):
        ...
        self.mu_g, self.log_sigma2_g, self.mu_o, self.log_sigma2_o, self.o_single_normal, self.mu_b, self.log_sigma2_b = self.initialize_variables()
        ...
        self.ell, self.pred_signals, self.real_signals = self.calculate_ell(self.g, self.o, self.b, self.train_data)
    ...
    def initialize_variables(self):
        ...
        return mu_g, log_sigma2_g, mu_o, log_sigma2_o, o_single_normal, mu_b, log_sigma2_b
    ...
    def calculate_ell(self, g, o, b, real_data):
        ...
        exp_y = tf.add(z, tf.matmul(b, noise))
